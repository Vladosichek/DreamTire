...
public class StationRequestDTO {
    ...
    public StationRequestDTO(String name, String adress, Long monStart, Long monFinish, Long tueStart, Long tueFinish, Long wenStart, Long wenFinish, Long thuStart, Long thuFinish, Long friStart, Long friFinish, Long satStart, Long satFinish, Long sunStart, Long sunFinish) {
        this.name = name;
        this.adress = adress;
